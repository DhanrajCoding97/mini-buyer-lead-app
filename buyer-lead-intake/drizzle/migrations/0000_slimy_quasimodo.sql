...
CREATE TYPE "public"."city" AS ENUM('Mumbai', 'Bangalore', 'Delhi', 'Chennai', 'Other');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "buyer_history" ADD CONSTRAINT "buyer_history_buyer_id_buyers_id_fk" FOREIGN KEY ("buyer_id") REFERENCES "public"."buyers"("id") ON DELETE no action ON UPDATE no action;